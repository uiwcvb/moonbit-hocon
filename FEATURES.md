...
- 独立大配置性能、内存/吞吐、多平台及持续负载。五进程计时中，普通浮点渲染相对 0.15 耗时减少 82.5%，当前/原版耗时比 7.057；次正规数与十进制幂相对 0.15 为 0.478、0.597，当前/原版为 945.942、13.106。十六项非渲染旧负载相对 0.15 为 0.918–1.042。最大进程中位数波动比 2.094，不稳定标记 true。完整性能仍未追平。 受控 GC 不代表生产内存验证。
