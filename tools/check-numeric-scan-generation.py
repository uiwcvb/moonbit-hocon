...
before = snapshot()
for command in [['node', 'tools/generate-collection-tests.mjs'], ['node', 'tools/generate-http-json-tests.mjs'], ['node', 'tools/generate-path-characters.mjs'], ['node', 'tools/generate-tree-tests.mjs'], ['node', 'tools/generate-document-tests.mjs'], ['node', 'tools/generate-numeric-characters.mjs'], ['node', 'tools/generate-accessor-tests.mjs'], ['node', 'tools/generate-temporal-tests.mjs'], ['node', 'tools/generate-persistent-core-tests.mjs'], ['node', 'tools/generate-path-tests.mjs'], ['node', 'tools/generate-value-tests.mjs'], ['node', 'tools/generate-value-walk-tests.mjs'], ['node', 'tools/generate-render-tests.mjs'], ['node', 'tools/generate-double-render-tests.mjs'], ['node', 'tools/generate-double-parse-tests.mjs'], [str(moon), 'fmt'],
...
(root / 'evidence/numeric-scan-generation.json').write_text(json.dumps(report, indent=2) + '\n', encoding='utf-8')
