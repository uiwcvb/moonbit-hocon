...
const args=process.argv.slice(2);let input,file,url,json=false,resolved=false,query,type,validateFile,entries=false;
...
try {
 ...
 if(type!==undefined&&!['value','string','boolean','int','long','double','duration','bytes','memory','list','has','has-or-null','null','entries','empty','resolved','string-list','boolean-list','int-list','long-list','double-list','duration-list','bytes-list','memory-list','config','config-list'].includes(type))throw new Error('Unknown getter type: '+type);
