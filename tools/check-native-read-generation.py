...
before = snapshot()
for command in [['node', 'tools/generate-collection-tests.mjs'], ['node', 'tools/generate-http-json-tests.mjs'], ['node', 'tools/generate-path-characters.mjs'], ['node', 'tools/generate-tree-tests.mjs'], ['node', 'tools/generate-document-tests.mjs'], ['node', 'tools/generate-numeric-characters.mjs'], ['node', 'tools/generate-accessor-tests.mjs'], ['node', 'tools/generate-temporal-tests.mjs'], ['node', 'tools/generate-persistent-core-tests.mjs'], ['node', 'tools/generate-path-tests.mjs'], [str(moon), 'fmt'],
...
report = dict(passed=True, files=len(after), checks=['independent collection, HTTP JSON, JDK path, tree, document and extended accessor and temporal API plus persistent raw-child/wrapped-resolution and native API path test generation', 'format', 'API generation', 'JS build and engine copy'], sha256=after)
(root / 'evidence/native-read-generation.json').write_text(json.dumps(report, indent=2) + '\n', encoding='utf-8')
